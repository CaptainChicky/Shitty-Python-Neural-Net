...
samples_per_class = 4000  # 500 black + 500 white = 1000 total
...
# Verify balance
num_black = sum(1 for output in data_entry_2 if output == [1])
num_white = sum(1 for output in data_entry_2 if output == [-1])
