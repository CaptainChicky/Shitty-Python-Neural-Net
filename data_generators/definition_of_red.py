...
print("=" * 80)
print(" " * 20 + "RGB Red Color Dataset Generation")
print("=" * 80)
print(f"\nConfiguration:")
...
############################################################################################################
print(f"\n{'='*80}")
print("PHASE 3: AXIS-ALIGNED SAMPLES (Cover R-axis, G-axis, etc.)")
print(f"{'='*80}")
...
num_red = sum(1 for output in data_entry_2 if output == [1])
num_not_red = sum(1 for output in data_entry_2 if output == [-1])
