    ...
    configs = {
        ...
        1: {
            ...
            'layers': lambda: [
                ...
                Layer(10, 5, 'hidden',
                      ...
                      bias_init='zeros'),
                Layer(5, 1, 'output',
                      activation_func=ActivationFunction.tanh) # default, we didnt need to specify
            ],
        ...
        3: {
            ...
            'layers': lambda: [
                ...
                Layer(12, 8, 'hidden',
                      activation_func=ActivationFunction.swish,
                      activation_params={'alpha': 1.01},
                      weight_init='he',
                      bias_init='zeros'),
                Layer(8, 1, 'output',
                      activation_func=ActivationFunction.sigmoid)  # Sigmoid for binCE
            ],
            ...
            'num_epochs': 2500,
            'num_samples': 1550,
            'cost_function': 'binary_crossentropy', # using binCE requires outputs/data to be 0 to 1
