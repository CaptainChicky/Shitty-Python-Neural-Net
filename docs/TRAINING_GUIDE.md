...
Pure SGD is too noisy, and you should try using mini-batch training with a reasonable number of samples depending on how much noise you want (16-256 ish).
