...
model_path = os.path.join(os.path.dirname(__file__), '..', 'models', 'model_optimized_iris.json')
...
fig.update_layout(
    ...
    hoverlabel=dict(
        namelength=-1  # Show full trace names on hover
    ),
    autosize=True,
    width=None,
    height=None,
    showlegend=True,
    legend=dict(
        itemsizing='constant',  # Makes all legend markers same size regardless of data
        itemwidth=40, 
        x=0.02,
        y=0.98,
