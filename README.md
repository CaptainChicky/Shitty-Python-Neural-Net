...
# Todo
 ...
 - [x] Allow setting a random seed for reproducibility when initing a network
 ...
 - [x] Adding noise to training data when processing (like MNIST) if the data is regularized, to be able to train more robust networks
